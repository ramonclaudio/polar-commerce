...
const nextConfig = {
  ...
  // This helps catch side effects and improves compatibility with future React features
  // NOTE: Convex auth tokens are now properly handled with useEffect cleanup
